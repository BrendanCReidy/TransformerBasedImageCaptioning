...
class DecoderBlock(tf.keras.Model):
    def __init__(self, d_model, dff, num_heads, target_vocab_size, maximum_position_encoding, rate=0.1):
        ...
        #self.ffn = point_wise_feed_forward_network(d_model, dff) not working (TODO: fix?)
    ...
    def call(self, x, enc_out, training, look_ahead_mask):
